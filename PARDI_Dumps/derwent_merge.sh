...
files="_agents _assignees _assignors _pat_citations _examiners _inventors _lit_citations _patents"
...
mv $merge_output/$prefix"_derwent_pat_citations_update.csv" $merge_output/$prefix"_derwent_citation_update.csv"
