...
exclude_tables="cg_ref_counts derwent_patents_filterred_to_nih_support fda_drug_patents fda_purple_cber_book fda_purple_cder_book wos_patent_mapping wos_pmid_manual_mapping wos_pmid_mapping"
exclude_string=""
